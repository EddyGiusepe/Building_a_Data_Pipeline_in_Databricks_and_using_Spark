...
====================================
Este script testa a conexão com o Databricks e carrega
dados do Volume Databricks.
...
try:
    ...
    spark = DatabricksSession.builder.remote(
        host=databricks_host, token=databricks_token, cluster_id=databricks_cluster_id
    ).getOrCreate()
    ...
    volume_path = (
        "/Volumes/workspace/default_eddy/volumeeddy-tmp-sampledata/sample_data.csv"
    )
    print(f"📂 Carregando dados do Volume Databricks (Eddy Giusepe): {volume_path}")
...
print("\n✅ Conexão com o Databricks estabelecida com sucesso!")
